...
const getGMIntroMessageSpecificPart = (
    userNotifyProps: Partial<UserNotifyProps> | undefined | null,
    ...
    if (isMuted) {
        return (
            <FormattedText
                ...
                values={{
                    b: (chunk: string) => (
                        <Text style={boldStyle}>{chunk}</Text>
                    ),
                }}
            />
        );
    ...
    const channelNotifyProp =
        channelNotifyProps?.push || NotificationLevel.DEFAULT;
...
const DirectChannel = ({
    ...
    return (
        <View style={styles.container}>
            <View style={styles.profilesContainer}>{profiles}</View>
